...
| 数据集 | 链接 | 适用场景 | 备注 |
| --- | --- | --- | --- |
| Pittsburgh 30k / 250k | [download](https://www.di.ens.fr/willow/research/netvlad/) | 城市级地点识别 | NetVLAD 常用 benchmark |
| Tokyo 24/7 | [download](https://www.di.ens.fr/willow/research/netvlad/) | 昼夜变化地点识别 | 常用于 VPR 泛化评估 |
| Mapillary Street-Level Sequences | [download](https://www.mapillary.com/dataset/places) | 大规模街景 VPR | 常简称 MSLS |
| Oxford RobotCar | [download](https://robotcar-dataset.robots.ox.ac.uk/) | 长期视觉定位 | 跨天气、昼夜和季节变化丰富 |
| Nordland | [download](https://nrkbeta.no/2013/01/15/nordlandsbanen-minute-by-minute-season-by-season/) | 季节变化地点识别 | 适合研究长时序外观变化 |
